...
class TestController extends Controller
{
    ...
    public function index(IndexRegion $request)
    {
        ...
        //print Carbon::now()->subMonth(2)->toDateTimeString();
        die;
    ...
    public function create()
    {
        ...
        return view('admin.test.create',['Country'=>Country::all()]);
    }
    public function GetCityList()
    {
        ...
        //foreach ($cityList as $city){
            $json[]=['title'=>'test','id'=>221];
            $json[]=['title'=>'test2','id'=>222];
        //}
    ...
    public function edit(Region $region)
    {
      //  $this->authorize('admin.region.edit', $region);
        ...
        return view('admin.test.edit', ['region' => $region,]);
    }
