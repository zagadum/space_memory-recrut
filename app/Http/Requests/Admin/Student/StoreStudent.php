    ...
    public function rules(): array
    {
        return [
          ...
          //  'teacher_id' => ['required', 'integer'],
            'email' => ['required', 'email', Rule::unique('student', 'email'),Rule::unique('franchisee', 'email'),Rule::unique('teacher', 'email'), 'string'],
            'subcribe_email' => ['nullable', 'email', Rule::unique('student', 'subcribe_email'), 'string'],
