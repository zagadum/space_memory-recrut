...
<modal-changecoins v-cloak inline-template >
    <modal class="admin-modal" name="ChangeCoinsModal" transition="pop-out"  :height="430" :focus-trap="false" @before-open="beforeOpen">
        ...
        <div class="box">
            ...
            <div class="row" >
                <div class="col-12" style="font-weight: bold" >
                    {{ trans('admin.student.changeBalance.current_balance') }}: <span v-text="dialogForm.balance"> </span>
                </div>
            </div>
            <form style="margin-top: 1em" method="post"  @submit.stop.prevent="handleSubmit" ref="formChangeBalanceStudent" >
                ...
                <div class="form-group row align-items-baseline">
                    <div class="col-md-12">
                        <label for="description" class="col-form-label text-md-left  col-md-5">{{ trans('admin.student.changeBalance.description') }}</label>
                        <div class=" dis-flex">
