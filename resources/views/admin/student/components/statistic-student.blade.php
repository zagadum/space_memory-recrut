<student-statistic-listing class="admin-table "
                         :data="[{}]"
                ...
                <div class="card-body" v-cloak>
                    <div class="card-block">
                        <div class="card-header">
                            ...
                            <a class="btn btn-create-item btn-spinner"  target="_blank" href="/admin/students/{{$student->id}}/statistic/print"
