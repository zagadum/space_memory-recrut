...
<div class="dp-wrap">
    ...
    <div class="dp-list">
        ...
        <div class="dp-card dp-card--unsigned">
            <div class="dp-card__file-icon">
                <i class="fas fa-file-alt"></i>
            </div>
            <div class="dp-card__info">
                <p class="dp-card__name">Договор 2026 Групповые занятия</p>
                <div class="dp-card__meta">
                    <span class="dp-card__date">
                        <i class="fas fa-calendar-alt" style="margin-right:4px;opacity:.5;"></i>
                        12.03.2026
                    </span>
                    <span class="dp-badge dp-badge--unsigned">
            ...
            <div class="dp-card__actions">
                <a href="/test-document-view" class="dp-btn-view" title="Просмотреть">
                    <i class="fas fa-eye"></i>
                </a>
                <a href="/test-document-view" class="dp-btn-sign">
        ...
        {{-- ── ДОКУМЕНТ ПОДПИСАН (пример) ── --}}
        {{-- Раскомментируй чтобы увидеть подписанное состояние:

        <div class="dp-card dp-card--signed">
            <div class="dp-card__file-icon" style="color: var(--green);">
                <i class="fas fa-file-alt"></i>
            </div>
            <div class="dp-card__info">
                <p class="dp-card__name">Договор 2025 Групповые занятия</p>
                <div class="dp-card__meta">
                    <span class="dp-card__date">
                        <i class="fas fa-calendar-check" style="margin-right:4px;opacity:.5;"></i>
                        Подписан 15.01.2025
                    </span>
                    <span class="dp-badge dp-badge--signed">
                        <span class="dp-badge__dot"></span>
                        Подписан
                    </span>
                </div>
